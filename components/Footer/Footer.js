...
const Footer = () => {
    return (
        ...
        <div className={" bg-gradient-to-r from-indigo-700  to-purple-900 ... p-20 m-0  "}>
            <div className=" inline ">

                <div>
                    <ul className={"inline space-x-7 "}>
                        <li className={" "}>
                            <img
                                className={" hover:scale-75 transition ease-in-out delay-300 bg-no-repeat duration-30 delay-10 w-32 h-32 rounded-2xl"}
                    ...
                    <div className={"float-right inline-flex -mt-64 "}>
                        <ul className={"inline-flex space-x-7 mr-7"}>
                            <li className={"hover:scale-125 transition ease-in-out delay-100 bg-no-repeat duration-30 delay-10 font-bold text-2xl font-mono tracking-widest uppercase "}>Login</li>
                            <li className={"hover:scale-125 transition ease-in-out delay-100 bg-no-repeat duration-30 delay-10 font-bold text-2xl font-mono tracking-widest uppercase "}>Register</li>

                        </ul>
                        <div className={"inline-flex hover:animate-bounce"}>
                            <img
                                src={"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Search_Icon.svg/1024px-Search_Icon.svg.png"}
                                className={"w-10 h-10 rounded-l rounded-b rounded-t rounded-r-none bg-white p-2 border-r border-black "}/>
                            <input type={"search"} placeholder={"Search"}
                                   className={"p-2 w-72 bg-white text-black rounded rounded-l-none  "}/>
